...
::: {.columns}
::: {.column width="50%"}
![Toutes espèces](assets/images/spatial-figure.png){height="600"}
:::
::: {.column width="50%"}
![Lepidoptera seulement](assets/images/spatial-figure-lepidoptera.png){height="600"}
:::
:::
...
%%{init: {'theme':'base', 'themeVariables': {'fontFamily':'Overpass, sans-serif','fontSize':'20px'}, 'flowchart': {'padding':34,'nodeSpacing':55,'rankSpacing':55,'curve':'linear'}}}%%
flowchart LR
    TAQC["<img src='assets/logos/taqc_logo.svg' width='360' height='228'/>"]
    GENO["<img src='assets/logos/Genovalia_Logo_Mauve.png' width='440' height='166'/>"]
